...
tar -cz $VAGRANT_BACKUP_LITE_EXCLUDED_FILES -f $VAGRANT_BACKUP_LITE_FILE_NAME $VAGRANT_BACKUP_PROCESSED_FILES 

if [ -f $VAGRANT_BACKUP_LITE_FILE_NAME ];
then
  echo "----------------------------------"
  echo "$VAGRANT_BACKUP_LITE_FILE_NAME created !"
  echo "----------------------------------"
else
